...
var RevueClient = /** @class */ (function () {
    ...
    RevueClient.prototype.request = function (url, _a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, cross_fetch_1.default("" + constants_1.API_BASE_URL + constants_1.API_PREFIX + url, __assign(__assign({}, init), { headers: __assign({ "Content-Type": "application/json", Authorization: "Token " + this.token }, headers), body: JSON.stringify(body) }))];
                    case 1:
                        res = _b.sent();
    ...
    RevueClient.prototype.getAllLists = function () {
        return this.request(constants_1.LISTS_ENDPOINT);
    };
    RevueClient.prototype.getSingleList = function (listId) {
        return this.request(constants_1.LISTS_ENDPOINT + "/" + listId);
    };
    // Issues
    RevueClient.prototype.getAllSentIssues = function () {
        return this.request(constants_1.ISSUES_ENDPOINT);
    };
    RevueClient.prototype.getCurrentIssue = function () {
        return this.request(constants_1.ISSUES_ENDPOINT + "/current");
    };
    RevueClient.prototype.getLastSentIssue = function () {
        return this.request(constants_1.ISSUES_ENDPOINT + "/latest");
    };
    // Items
    RevueClient.prototype.getInboxItems = function () {
        return this.request(constants_1.ITEMS_ENDPOINT);
    };
    RevueClient.prototype.addItemToIssue = function (issueId, body) {
        return this.request(constants_1.ISSUES_ENDPOINT + "/" + issueId + "/items", {
            method: "POST",
            body: body,
        });
    };
    ...
    RevueClient.prototype.getAllSubscribers = function () {
        return this.request(constants_1.SUBSCRIBERS_ENDPOINT);
    };
    RevueClient.prototype.getAllUnsubscribed = function () {
        return this.request(constants_1.SUBSCRIBERS_ENDPOINT + "/unsubscribed");
    };
    ...
    RevueClient.prototype.getAllExports = function () {
        return this.request(constants_1.EXPORTS_ENDPOINT);
    };
    RevueClient.prototype.getSingleExport = function (exportId) {
        return this.request(constants_1.EXPORTS_ENDPOINT + "/" + exportId);
    };
    RevueClient.prototype.startExport = function (listId) {
        return this.request(constants_1.EXPORTS_ENDPOINT + "/lists/" + listId, {
            method: "POST",
        });
    };
    // Profile
    RevueClient.prototype.getProfileUrl = function () {
        return this.request(constants_1.ACCOUNTS_ENDPOINT + "/me");
    };
    return RevueClient;
}());
exports.default = RevueClient;
